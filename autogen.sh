...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_ess to login script."
...
# the current dir:
if   test x${GTLANG_ess} = x ; then
	echo "WARNING: The variable \${GTLANG_ess} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_ess} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_ess} has the value:"
	echo "  ${GTLANG_ess}"
