...
This directory contains source files for the Central Siberian Yupik
...
In order to compile and use Central Siberian Yupik language morphology
...
The Central Siberian Yupik language sources can be acquired using
[giella SVN
